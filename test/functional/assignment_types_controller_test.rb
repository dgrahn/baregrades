...
class AssignmentTypesControllerTest < ActionController::TestCase
  ...
  test "should create assignment_type" do
    assert_difference('AssignmentType.count') do
      post :create, assignment_type: { course_id: @assignment_type.course_id, description: @assignment_type.description, name: @assignment_type.name, worth: @assignment_type.worth }
    end
  ...
  test "should update assignment_type" do
    put :update, id: @assignment_type, assignment_type: { course_id: @assignment_type.course_id, description: @assignment_type.description, name: @assignment_type.name, worth: @assignment_type.worth }
    assert_redirected_to assignment_type_path(assigns(:assignment_type))
  end
